...
const ARCHITECTURE_STEPS = [
  ...
  { step: '4', label: 'Emotional Layer (Claude)', desc: 'Generates warm opening in warm_friend register' },
  ...
  { step: '7', label: 'Soch Orchestrator (Claude)', desc: 'Synthesises 3 verdicts → 2-sentence final reasoning' },
